   ...
   function Finalize(props) {
    ...
    const saveToDatabase= async()=>{
      ...
      if(user.resumeIds != undefined){
        obj = {...user.resumeIds , [documentd.id] :
        {educationSection :educationSection , contactSection : contactSection , 
        document : documentd}}
      }else {
        obj = { [documentd.id] : {educationSection : educationSection ,
          contactSection : contactSection , document : documentd}}
      }
     ...
     const downloadResume=()=> {
      ...
      console.log(document)
       html2canvas(input) //it will convert html code to image
         .then((canvas) => {
